...
| Administrator | View/change ordinary organization and branding settings, view/change users, assign non-Owner roles, view audit events, view/add/change packages, view/add/change subscriptions, view/add/change subscribers, view/add/change services |
| Finance | View organization and branding, view audit events, view packages, view subscriptions, view subscribers, view services |
| NOC | View organization and branding, view audit events, view packages, view subscriptions, view subscribers, view services |
| SuperSurf Support | View organization and branding, view users, view packages, view subscriptions, view subscribers, view services |
| Read Only | View organization, branding, users, audit events, packages, subscriptions, subscribers, and services |
...
Ordinary roles do not receive `billing.delete_plan`, `billing.delete_subscription`, `subscribers.delete_subscriber`, or `subscribers.delete_service`. Packages, subscribers, and services are deactivated rather than deleted through normal workflows. Subscriptions are ended rather than deleted.
