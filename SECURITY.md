...
Subscriber and service mutations must go through audited service-layer functions. Subscriber account numbers and service references are generated by locked allocation rows, immutable through model save, queryset update, and bulk update paths, and never exposed as form fields.
